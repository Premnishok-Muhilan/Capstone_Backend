...
const userController = {
  ...
  register_for_an_event: async (request, response) => {
    try {
      console.log("inside the register event\n");
      ...
      console.log("Selected_Seat_Nos", Selected_Seat_Nos);
  ...
  get_all_registrations: async (request, response) => {
    try {
      console.log("Inside the get all registrations method");
  ...
  transfer_tickets: async (request, response) => {
    try {
      ...
      console.log("Inside the transfer tickets!");
      console.log(request.body);
      ...
      await event.save();
      console.log("event.Attendee_Ids", event.Attendee_Ids);
  ...
  forgotPassword: async (request, response) => {
    try {
      ...
      console.log("type of resetToken", typeof resetToken);
